...
## 1️⃣ Backend Setup (Express.js + Sequelize + PostgreSQL)
...
## 2️⃣ Frontend Setup (Next.js + TailwindCSS + shadcn/ui)
```bash
...
backend/
│── src/
│   ├── models/        # Sequelize models (Warehouse, Product, Stock, etc.)
...
│   └── server.js      # Express app entry point (CORS, JSON parsing)
│
...
frontend/
│── app/
│   ├── page.tsx                    # Stock Dashboard (Home)
│   ├── purchase-requests/
│   │   ├── page.tsx               # Purchase Requests List
│   │   └── [id]/
│   │       └── page.tsx           # Edit/View Purchase Request Detail
│   └── warehouses/
│       └── page.tsx               # Warehouses Management (to be implemented)
│
├── components/
...
✅ **Sequelize ORM** — Maps to existing SQL tables (no auto-sync)  
✅ **Manual SQL Schema** — Tables created manually for better control  
✅ **Layered Structure** — Services → Controllers → Routes → server.js  
✅ **Service Layer** — Keeps database queries clean and reusable  
✅ **Controllers** — Handle:
- Business logic
- Input validation
...
✅ **Modular Routes** — Separated by resource for clarity  
...
✅ **shadcn/ui** — Consistent, accessible, modern component library  
✅ **TailwindCSS** — Fast styling workflow with utility classes  
✅ **TypeScript** — Type safety for better developer experience  
✅ **Client Components** — `'use client'` for interactive dashboards  
✅ **Dynamic Routes** — `/purchase-requests/[id]` for edit functionality  
✅ **Real-time Data Enrichment** — Fetches related warehouse & product names  
...
**Stock Management:**
- Color-coded quantities for visual assessment (Green >50, Yellow >20, Red ≤20)
